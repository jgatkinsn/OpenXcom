...
// this should probably be any small screen touch-device, i don't know the defines for all of them so i'll cover android and IOS as i imagine they're more common
	...
	_info.push_back(OptionInfo("interceptorRangeStatus", &interceptorRangeStatus, false, "STR_INTERCEPTOR_RANGE_STATUS", "STR_OXCE"));
	...
	_info.push_back(OptionInfo("keyCurrentGlobalResearch", &keyCurrentGlobalResearch, SDLK_c, "STR_CURRENT_GLOBAL_RESEARCH", "STR_OXCE"));
